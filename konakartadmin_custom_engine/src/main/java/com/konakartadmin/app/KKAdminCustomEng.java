...
protected KKAdminException manageThrowable(Throwable e)
{
     ...
     * status id. You may select the order status id or alternatively set the id of the objects to -1
     * in order for the system to assign an Id. An exception will be thrown if the selected id
     * already exists.
     * 
     * @param sessionId
     *            The session Id of the logged in user
