...
Note the configuration settings on your Valitor account and follow the
recommended security best-practices advice.

Install and configure the relevant Valitor configuration parameters in the
KonaKart Admin App.
...
* Enable or disable Valitor itself
* Set the sort order for Valitor (the order it is shown if there are more
