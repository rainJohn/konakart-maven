...
public class ValitorAction extends BaseGatewayAction
{
     ...
     */
    protected Log log = LogFactory.getLog(ValitorAction.class);
    ...
    public String execute()
    {
        ...
        try
        {
             ...
             */
            String uuid = request.getParameter(ValitorAction.custom);
            if (uuid == null)
            {
                throw new Exception(
            ...
            while (en.hasMoreElements())
            {
                ...
                if (paramName != null)
                {
                    if (paramName.equalsIgnoreCase(ValitorAction.payment_status))
                    {
                        paymentStatus = paramValue;
                    } else if (paramName.equalsIgnoreCase(ValitorAction.txn_id))
                    {
                        txnId = paramValue;
                    }
                }
