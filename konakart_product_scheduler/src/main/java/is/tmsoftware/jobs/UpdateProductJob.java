 ...
 * @author bjarnig
 */
public class UpdateProductJob extends BaseApi implements Job {

    protected Log log = LogFactory.getLog(UpdateProductJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            ...
            if (productIf != null) {
                System.out.println("#######################################################");
                System.out.println("Existing product: " + productIf.getId());
                System.out.println("#######################################################");
            } else {
